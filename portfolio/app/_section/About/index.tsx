    ...
    <>
      ...
      <div className="mx-auto mt-20 max-w-[400px] tracking-widest">
        <span className="mx-auto w-fit block">
          <p className="font-bold text-lg">Eda Motoki</p>
          <p className="font-bold text-xl">江田 企毅</p>
        </span>

        <p className="tracking-widest mt-10 w-11/12 mx-auto leading-loose">
        ...
        <div className="mt-10">
          {Career.map((career, index) => (
            ...
            >
              ...
              <p className="text-sm tracking-[0.24em] leading-loose ">
                {career}
              </p>
            </div>
          ))}
        ...
        <div className="mt-10">
          <h3 className="text-lg py-4 pl-2 border-b-1 border-b-border text-center">
            MotoDesign
          </h3>
          <div className="mt-10">
            ...
            <p className="text-sm mt-4 leading-loose tracking-[0.2em]">
